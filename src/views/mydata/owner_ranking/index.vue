                            ...
                            >
                                ...
                                <cy-col>
                                    ...
                                    <div class="flex center">
                                        ...
                                        <div
                                            class="assist"
                                            :class="item.browseRatio<0?'red':'skyblue'"
                                        >
                                            <cy-icon
                                ...
                                <cy-col>
                                    ...
                                    <div class="flex center">
                                        ...
                                        <div
                                            class="assist"
                                            :class="item.buyRatio<0?'red':'skyblue'"
                                        >
                                            <cy-icon
...
export default {
    ...
    data() {
        return {
            ...
            dataListParams: {
                shareUserPk: this.$store.state.user.pk, //车主pk
                startTime: "",
                endTime: "",
                province: "",
                city: "",
        ...
        getDataList(option = {}) {
            ...
            this.$api
                ...
                .then((res) => {
                    ...
                    if (this.pageNum === 1 && res.obj.memberDto) {
                        list.unshift({
                            ...res.obj.memberDto,
                            me: true,
                        });
                    }
                    list = res.obj.page.map((item) => {
                        const [
                            rewardMoneyCurrentValue,
                            rewardMoneyRatio,
                        ] = this.computeRatio(
